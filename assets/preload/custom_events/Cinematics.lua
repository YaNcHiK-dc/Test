...
function onCreate()
	...
	--THE TOP BAR
	makeLuaSprite('UpperBar', 'empty', -600, -620)
	makeGraphic('UpperBar', 9280, 520, '000000')
	setObjectCamera('UpperBar', 'other')
	addLuaSprite('UpperBar', false)


	--THE BOTTOM BAR
	makeLuaSprite('LowerBar', 'empty', 0, 1020)
	makeGraphic('LowerBar', 9280, 9120, '000000')
...
function onUpdate()
	...
	doTweenY('Cinematics1', 'UpperBar', -355, 0.5, 'Linear')
	doTweenY('Cinematics2', 'LowerBar', 805, 0.5, 'Linear')
	noteTweenY('NOTEMOVE1', 0, 160, 0.5, 'Linear')	
	noteTweenY('NOTEMOVE2', 1, 160, 0.5, 'Linear')
	noteTweenY('NOTEMOVE3', 2, 160, 0.5, 'Linear')
	noteTweenY('NOTEMOVE4', 3, 160, 0.5, 'Linear')
	noteTweenY('NOTEMOVE5', 4, 160, 0.5, 'Linear')
	noteTweenY('NOTEMOVE6', 5, 160, 0.5, 'Linear')
	noteTweenY('NOTEMOVE7', 6, 160, 0.5, 'Linear')
	noteTweenY('NOTEMOVE8', 7, 160, 0.5, 'Linear')
	...
	doTweenY('Cinematics1', 'UpperBar', -620, 0.5, 'Linear')
	doTweenY('Cinematics2', 'LowerBar', 1020, 0.5, 'Linear')
